       ...
       <!--//Admin Sidebar-->
        ...
        <div class="page-content">
            <div class="admin-container">
              <form action="create.php" method="post" class="admin-form sm-box">
                <h1 class="center form-title">Create Users</h1>
               ...
               <!--
                ...
                <div class="input-group">
                    <button type="submit" name="create-admin" class="btn primary-btn big-btn">Create User</button>
                </div>
              </form>
          </div>
        </div>
