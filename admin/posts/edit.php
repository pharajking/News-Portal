       ...
       <!--//Admin Sidebar-->
        ...
        <div class="page-content">
            <div class="admin-container">
              <form action="edit.php" method="post" class="admin-form md-box" enctype="multipart/form-data">
                <h1 class="center form-title">Edit Create Post</h1>
               ...
               <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                ...
                <div class="input-group">
                    <button type="submit" name="update-post" class="btn primary-btn big-btn">Update Post</button>
                </div>
              </form>
          </div>
        </div> 
